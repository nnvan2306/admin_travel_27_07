...
const items: MenuItem[] = [
    ...
    },
    {
        ...
        label: "Phân quyền",
        icon: <MdSecurity />,
        children: [{ key: "/authorization", label: "Phân quyền tài khoản" }],
    },
    ...
    //     children: [{ key: "/notifications", label: "Danh sách thông báo" }],
    // },
...
export default function Dashboard() {
    ...
    return (
        <div
            className={`fixed z-1 top-[70px] left-0 h-[calc(100vh-70px)] min-h-[calc(100vh-70px)]  transition-all duration-300 overflow-hidden ${
