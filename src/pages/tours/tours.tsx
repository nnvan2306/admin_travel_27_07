...
export default function Tours() {
    ...
    const [targetToggleStatus, setTargetToggleStatus] = useState<
    ...
    const fetchTours = async () => {
        ...
        try {
            ...
            const tours: TourType[] = res.data.filter(
                (tour: TourType) =>
                    role === "admin" || tour.is_deleted === "active"
            );
            setData(tours);
        } catch {
    ...
    const columns: ColumnsType<TourType> = [
        ...
        },
        {
            ...
            width: 120,
            render: (val) => (val ? `${val} người` : "Chưa có"),
        },
    ];
            ...
            if (role === "admin") {
                items.push(
                    ...
                    },
                    {
                        key: "force-delete",
                        label: (
                            <span style={{ color: "red" }}>Xóa vĩnh viễn</span>
                        ),
                    }
                );
            } else if (role === "staff") {
            ...
            <Modal
                ...
                footer={[
                    ...
                    <Button
                        ...
                        danger
                        onClick={() =>
                            targetId !== null && handleDelete(targetId)
                        }
                        loading={loading}
                    >
                        Xóa
